...
import { UserOutlined, ShopOutlined, CalendarOutlined, FileTextOutlined, SafetyOutlined, LogoutOutlined } from '@ant-design/icons';
...
const allMenuItems = [
  ...
  { key: '/invoice', icon: <FileTextOutlined />, label: '請求書・注文書管理', adminOnly: true },
