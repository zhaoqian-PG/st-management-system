...
COMMENT ON COLUMN purchase_order.recipient_dept IS '受注先部署';
COMMENT ON COLUMN purchase_order.recipient_name IS '受注先担当者';
COMMENT ON COLUMN purchase_order.recipient_addr IS '受注先住所';
COMMENT ON COLUMN purchase_order.recipient_tel IS '受注先TEL';
