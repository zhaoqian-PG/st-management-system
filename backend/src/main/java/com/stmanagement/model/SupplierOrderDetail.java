...
@Entity @Table(name = "supplier_order_detail")
public class SupplierOrderDetail {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Long id;
    @Column(name = "order_id", nullable = false) private Long orderId;
    @Column(name = "employee_name", length = 100) private String employeeName;
    @Column(name = "item_name", length = 500, nullable = false) private String itemName;
